...
<head>
    ...
    <script src="../../js/backStageManagement/role.js"></script>
    <style>
                    ...
                    <div class="panel-body">
                        <div class="row " style="margin-top: 10px;">
                            <form class="form-horizotal col-xs-12 btn-slect-drop " style="padding: 0px;">
                                <div class="col-lg-6">
                                    <button type="button" class="ys-btn btn-primary " id="btn-open">创建角色</button>
                                ...
                                <div class="col-lg-6">
                                    <div class="pull-right btn-search sx-b5px-r20px" style="height: 32px;">
                                        <div class="ys-single-query">
                                            <input class="ys-form-control" placeholder="输入角色名称" id="selText">
...
<!-- =====================================以下是模态框=========================== -->
<!--添加角色-->
<div class="modal fade" id="RoleModal" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal"
     aria-hidden="true">
    <div class="modal-dialog modal-md ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class=" form-horizontal form-padding" id="addRole" style="padding-right:15px">
            ...
            <div class="modal-body">
                <form class="form-horizontal form-padding" style="padding-right:15px" id="EditForm">
                    <div class="form-group groupList">
                        <label class="col-md-3 control-label" for="demo-text-input">角色名称</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" autocomplete="off" id="name1" name="name1">
                        </div>
                    </div>
                </form>
            </div>
